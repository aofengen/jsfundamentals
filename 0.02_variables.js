...
// name = "Madyson"; //initialization of variable
// console.log(typeof(name));
// console.log(name);
// var lastName = "Ward";//declaration and initialization of variable
// console.log(name.length);
// console.log(name.toUpperCase());
// console.log(lastName);
// //Challenge: Create two variables 'firstName' and 'lastName' and concat them together into a third variable called fullName
// var firstName = "Aaron";
// lastName = "Ofengender";
